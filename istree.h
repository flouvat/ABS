...
extern void    ist_count   (ISTREE *ist, int * sets, int cnt, int & nbfreq, int minsup);

extern void    ist_countx  (ISTREE *ist, TATREE *tat, int & nbfreq, int minsup);

extern int     ist_settac  (ISTREE *ist, int cnt);
extern int     ist_gettac  (ISTREE *ist);
extern int     ist_check   (ISTREE *ist, char *marks);

extern int     ist_addlvl  (ISTREE *ist, int & nbgen);
...
extern int     ist_getcntx (ISTREE *ist, int *sets, int cnt);

extern void    ist_filter  (ISTREE *ist, int mode);

extern void    ist_filter2  (ISTREE *ist, int mode,Trie * bdn);

extern void    ist_init    (ISTREE *ist);
extern int     ist_set     (ISTREE *ist, int *sets, int *supp);
